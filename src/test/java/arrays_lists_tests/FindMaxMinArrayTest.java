...
import arrays_lists.FindMaxMinArray;
...
class FindMaxMinArrayTest {
    ...
    class FindMaxTests {
        ...
        @MethodSource("arrays_lists_tests.FindMaxMinArrayTest#provideArraysForMaxTest")
        @DisplayName("Тесты для метода findMax")
    ...
    class FindMinTests {
        ...
        @ParameterizedTest(name = "Массив: {0}, Ожидаемый Max: {1}")
        @MethodSource("arrays_lists_tests.FindMaxMinArrayTest#provideArraysForMinTest")
